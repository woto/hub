...
gem 'elasticsearch-model', branch: 'main', github: 'woto/elasticsearch-rails', glob: 'elasticsearch-model/*.gemspec'
gem 'elasticsearch-persistence'
gem 'elasticsearch-rails', branch: 'main', github: 'woto/elasticsearch-rails'
