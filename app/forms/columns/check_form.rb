...
module Columns
  class CheckForm < BaseForm
    ...
    self.all_columns = [
        ...
        { key: 'is_payed',            pg: Check.columns_hash['is_payed'], roles: ['user', 'manager', 'admin'] },
        { key: 'payed_at',            pg: Check.columns_hash['payed_at'], roles: ['user', 'manager', 'admin'] },
        { key: 'user_id',             pg: Check.columns_hash['user_id'], roles: ['user', 'manager', 'admin'] },
