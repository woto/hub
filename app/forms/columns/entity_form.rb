...
module Columns
  class EntityForm < BaseForm
    DEFAULTS = %w[id image title lookups created_at].freeze
    ...
    self.all_columns = [
      ...
      { key: 'lookups',             pg: Lookup.columns_hash['title'], roles: ['user', 'manager', 'admin'] },
      { key: 'lookups_count',       pg: Entity.columns_hash['lookups_count'], roles: ['user', 'manager', 'admin'] },
