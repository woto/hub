...
module Accounting
  module Posts
    class TransitToCanceled
      ...
      before do
        unless Accounting::Posts::StatusPolicy.new(Current.responsible, context.post).to_canceled?
          raise Pundit::NotAuthorizedError,
                "User with role `#{Current.responsible.role}` not allowed to Post#to_canceled?"
        end
      end
