...
module Accounting
  module Posts
    class TransitToRejected
      ...
      before do
        unless Accounting::Posts::StatusPolicy.new(Current.responsible, context.post).to_rejected?
          raise Pundit::NotAuthorizedError,
                "User with role `#{Current.responsible.role}` not allowed to Post#to_rejected?"
        end
      end
