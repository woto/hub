  ...
  module YoutubeCom
    class Index
      ...
      def call
        ...
        if watch.call
          result = Extractors::YoutubeCom::ListVideos.call(id: watch.call).object.to_h
        ...
        if playlist.call
          result = Extractors::YoutubeCom::ListPlaylists.call(id: playlist.call).object.to_h
        ...
        if user.call
          result = Extractors::YoutubeCom::ListChannels.call(for_username: user.call).object.to_h
        ...
        if c.call
          result = Extractors::Metadata::Iframely.call(url: c.call).object
        ...
        if channel.call
          result = Extractors::YoutubeCom::ListChannels.call(id: channel.call).object.to_h
