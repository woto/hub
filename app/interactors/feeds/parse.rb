...
module Feeds
  class Parse
    ...
    def categories_open
      @categories = Import::CategoriesCreator.new(feed: context.feed)
    end

    def offers_open
      Import::Categories::BindParents.call(feed: context.feed)
      @offers = Feeds::Offers.new(feed: context.feed)
    end
