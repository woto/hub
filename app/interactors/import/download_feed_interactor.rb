    ...
    def call
      ...
      File.open(context.feed.file.path, 'wb') do |f|
        ...
        begin
          ...
          raise Import::ProcessInteractor::HTTPServerException, e
        rescue Faraday::TimeoutError => e
          raise Import::ProcessInteractor::ReadTimeout, e
        rescue Faraday::BadRequestError => e
          raise Import::ProcessInteractor::BadRequestError, e
        end
