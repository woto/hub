  ...
  module Offers
    class Category
      ...
      def self.call(offer, feed, categories)
        ...
        feed_category = Import::Offers::SurrogateCategory.call(feed, categories, feed_category) if has_children
        set_offer_values(offer, feed_category.id, feed_category.path_ids)
      rescue CategoryError => e
        feed_category = Import::Offers::SurrogateCategory.call(feed, categories)
