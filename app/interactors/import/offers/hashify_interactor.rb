  ...
  module Offers
    class HashifyInteractor
      ...
      def self.hashify(child)
        ...
        raise Import::ProcessInteractor::ElasticUnexpectedNestingError, child.to_s unless child.elements.empty?

        # TODO: May be should use simple format? What about XSS?
        raise Import::ProcessInteractor::ElasticUnexpectedNestingError, child.to_s if child.children.reject(&:text?).size > 1
