...
export default function Complain(props: {
  ...
  const onSubmit = data => {
    axios.post('/api/complains', {...data, ...{data: props.data}})
                          ...
                          <AnimatePresence>
                            <motion.svg 
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                 stroke="currentColor" className="tw-w-10 tw-h-10">
                              <motion.path
                      ...
                      <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <textarea
                          ...
                          className={`tw-shadow-sm 
                            ${errors.text ? 'focus:tw-ring-red-500' : 'focus:tw-ring-indigo-500'}
                            ${errors.text ? 'focus:tw-border-red-500' : 'focus:tw-border-indigo-500'} 
                        ...
                        />
                          ...
                          <div className={"tw-text-xs tw-mt-2 tw-text-gray-500"}>
                            Сообщайте пожалуйста нам о неправильных описаниях, дубликатах, нарушениях авторских прав и
                            т.д. через эту форму.
                          </div>
                        </div>
                        ...
                        <div className="tw-mt-4">
                          <button type='submit'
                                ...
                                tw-border-transparent tw-shadow-sm tw-px-4 tw-py-2 tw-bg-red-600 tw-text-base
