...
const publishingOptions = [
  { title: 'Любое', description: '', current: true },
  { title: 'Позитивное', description: '', current: false },
  { title: 'Негативное', description: '', current: false },
]
...
export default function Sentiment() {
  ...
  return (
    <div className={'tw-text-left tw-relative tw-grid tw-grid-cols-2 tw-items-center'}>
      <div className={'tw-mb-1 tw-text-sm tw-font-medium tw-text-gray-700'}> Настроение: </div>
