...
import {
  Bars3Icon, BellIcon, MagnifyingGlassIcon, QueueListIcon, XMarkIcon,
...
export default function Header(props: {
  ...
  return (
    <div className="tw-min-h-full?">
      <Disclosure
        as="nav"
        className="tw-z-40 tw-relative tw-bg-gray-800 lg:tw-bg-gray-200 tw-border-b tw-border-gray-400 tw-border-opacity-25 tw-lg:border-none"
      >
        {({ open }) => (
          <>
            <div className="tw-max-w-5xl tw-mx-auto tw-px-2 sm:tw-px-4 lg:tw-px-8">
              <div
                        ...
                        <a
                          ...
                          className={classNames(
                            item.current
                              ...
                              : 'tw-text-slate-800 tw-bg-white  hover:tw-shadow focus:',
                  ...
                  <div className="tw-flex tw-items-center tw-gap-6">
                    ...
                    {true
                        ...
                        <Menu as="div" className="tw-ml-3 tw-relative tw-flex-shrink-0">
                          ...
                          >
                            <Menu.Items
                              className="tw-origin-top-right tw-absolute tw-right-0 tw-mt-2 tw-w-48 tw-rounded-md  tw-py-1 tw-bg-white tw-ring-1 tw-ring-black tw-ring-opacity-5 focus:tw-outline-none"
                            >
