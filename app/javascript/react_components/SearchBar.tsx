import {
  Fragment, RefObject, useCallback, useEffect, useRef, useState,
} from 'react';
...
export default function SearchBar(props: {
  ...
  return (
    ...
    <div className="tw-flex tw-rounded-md ">
      ...
      <div className="tw-relative tw-flex tw-items-stretch tw-flex-grow focus-within:tw-z-10">
        <input
          ...
          data-selector="search-text"
          className="!tw-text-white/70 lg:!tw-text-gray-900 tw-text-sm tw-border-gray-700 lg:tw-border-gray-300 tw-bg-slate-900 lg:tw-bg-white focus:tw-ring-indigo-500 focus:tw-border-indigo-500 tw-block tw-w-full tw-rounded-none tw-rounded-l-md"
        />

        <div className="tw-absolute tw-inset-y-0 tw-right-0 tw-flex tw-py-1.5 tw-pr-1.5">
          <button
            className="!tw-text-gray-400 hover:!tw-text-gray-600 focus:!tw-text-gray-400 tw-inline-flex tw-items-center tw-rounded tw-px-2 focus:tw-outline-0"
            onClick={clearInput}
          >
      ...
      >
        ...
        {props.items.length > 1
          ...
          >
            ...
            <Menu.Items
              static
              className="tw-z-10 tw-min-w-[300px] tw-origin-top-right tw-absolute tw-right-0 tw-mt-2 tw-w-56 tw-rounded-md  tw-bg-white tw-ring-1 tw-ring-black tw-ring-opacity-5 focus:tw-outline-none"
            >
