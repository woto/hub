...
ActiveRecord::Schema.define(version: 2020_12_26_100813) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["exchange_rate_id"], name: "index_posts_on_exchange_rate_id"
  ...
  add_foreign_key "posts", "exchange_rates"
