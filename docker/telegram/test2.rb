...
ActiveRecord::Base.establish_connection(
  adapter: 'postgresql',
  database: 'mention_development'
)

class Entity < ActiveRecord::Base
end

new_user = Entity.new(title: 'Dano')
new_user.save
    ...
    when Telegram::Bot::Types::Message
      ...
      when '/start'
        ...
        begin
          ...
          kb = [
            Telegram::Bot::Types::InlineKeyboardButton.new(text: 'Выбрать', switch_inline_query_current_chat: "#{SecureRandom.uuid}: #{fragment[:text_start]}"),
          ]
