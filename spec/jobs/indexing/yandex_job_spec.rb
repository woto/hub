...
RSpec.describe Indexing::YandexJob, type: :job do
  subject { described_class.perform_now(url: 'http://example.com') }

  it 'successfully finishes when 200 response code' do
    url = 'https://yandex.com/indexnow?key=index_now_key_value&keyLocation=https://goodreviews.ru/index_now_key_value&url=http://example.com'
