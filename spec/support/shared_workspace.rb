...
RSpec.shared_examples 'shared_workspace' do |class_name, flag|
  ...
  context 'when user authorized' do
    ...
    context 'when url contains `display workspace form` `dwf=1`' do
    ...
    context 'when url does not contain `display workspace form` `dwf=1`' do
    ...
    context 'when name filled into form' do
      ...
      context 'when name does not filled' do
        let('name') { Faker::Lorem.word }
